...
setup(
    ...
    description='Package based on the text book: Advances in Financial Machine Learning, by Marcos Lopez de Prado',  # Optional
    ...
    keywords='machinelearning finance investment education',  # Optional
